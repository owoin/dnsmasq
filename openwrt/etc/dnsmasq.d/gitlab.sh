...
&& wget -P /etc/dnsmasq.d/conf -O /etc/dnsmasq.d/conf/ip.conf --no-check-certific--no-check-certificate https://raw.githubusercontent.com/vokins/yhosts/master/dnsmasq/ip.conf \
\
