...
&& wget -P /etc/dnsmasq.d -O /etc/dnsmasq.d/isp.conf --no-check-certificate https://raw.githubusercontent.com/owoin/dnsmasq/master/openwrt/etc/dnsmasq.d/conf/isp.conf \
